...
public class BusesAreUs extends Activity implements LocationListener, StopSelectionListener {
    ...
    public void onLocationChanged(Stop nearest, LatLon locn) {
        this.nearestStopLabel = (TextView)this.findViewById(R.id.nearestStopLabel);
        if(nearest != null) {
            this.nearestStopLabel.setText(nearest.getName());
        } else {
            this.nearestStopLabel.setText("Stops all out of range");
        }
    }
